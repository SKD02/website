...
def detect(inp: DetectIn, request: Request):
    ...
    user_msg = (
        ...
        "- объём tech31 не меньше 120–180 слов;\n"
        "- оформи tech31 структурированно: назначение; состав/материалы; ключевые узлы/микросхемы; интерфейсы/порты; электрические параметры; габариты/масса; условия эксплуатации; стандарты/соответствия; комплектация.\n"
